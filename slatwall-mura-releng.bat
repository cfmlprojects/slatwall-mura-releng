...
cls
echo.
echo       slatwall-mura-releng menu
REM echo       usage: slatwall-mura-releng.bat [start|stop|{target}]
echo.
...
echo to stop the server, run this again or run: slatwall-mura-releng.bat stop
goto end
::
:stopServer
